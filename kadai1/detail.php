...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="#">書籍情報の更新</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="index.php">書籍登録</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="select.php">書籍一覧</a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <form method="post" action="update.php">
    ...
    <div class="form-group">
      ...
      <input type="url" class="form-control" id="url" name="url" value="<?= $rs["url"] ?>">
    </div>
    <div class="form-group">
